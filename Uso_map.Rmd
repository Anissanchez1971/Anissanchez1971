...
Útil para aplicar una función a cada elemento de una lista, y en casos más sofisticados se puede especificar el tipo de caracter que se desea obtener.

Especificamente, devuelve una lista en columnas, estableciendo como argumentos: 
